...
module Config
  ...
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/andreas/cross-compile/ruby-mingw32")
  CONFIG["EXEEXT"] = ".exe"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["CCDLFLAGS"] = ""
  CONFIG["LDSHARED"] = "i386-mingw32-g++ -shared -s"
  CONFIG["DLEXT"] = "so"
  CONFIG["DLEXT2"] = "dll"
  CONFIG["LIBEXT"] = "a"
  CONFIG["LINK_SO"] = ""
  ...
  CONFIG["EXTSTATIC"] = ""
  CONFIG["setup"] = "Setup"
  CONFIG["MINIRUBY"] = "ruby -I/home/andreas/cross-compile/ruby-1.8.6-p111 -rfake"
  CONFIG["PREP"] = "fake.rb"
  ...
  CONFIG["configure_args"] = " '--host=i386-mingw32' '--build=i686-linux' '--prefix=/home/andreas/cross-compile/ruby-mingw32' 'build_alias=i686-linux' 'host_alias=i386-mingw32'"
